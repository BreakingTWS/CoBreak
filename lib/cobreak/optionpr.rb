  ...
  class ParseOPT
    def self.optparse(options)
      ...
      OptionParser.new do|param|
        ...
        param.on('-b', '--brutewordlist=DIGEST', String, 'brute force mode to crack a hash whitch wordlist format'){|modeforce|options.bruteforce = modeforce}
        param.on('-bc', '--brutechar=DIGEST', String, 'brute force mode to crack a hash whitch char generator format'){|modeforce|options.bruteforce = modeforce}
        param.on('-bc', '--brutecipher=CIPHER', String, 'brute force mode to crack a hash cipher wordlist format'){|modeforce|options.bruteforce = modeforce}
        param.on('-br', '--brutecipherchar=CIPHER', String, 'brute force mode to crack a cipher whitch char generator'){|modeforce|options.bruteforce = modeforce}
        param.separator ""
